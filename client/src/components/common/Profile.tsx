    ...
    >
      ...
      >
        <img
          ...
          src = "https://images.unsplash.com/photo-1551524164-687a55dd1126?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1025&q=80"
        ...
        >
          <Box flex={1} display="flex" flexDirection={{ xs: 'column', md: 'row' }} gap="20px">
            <img
              ...
              src={checkImage(avatar) ? avatar : avatar1 }
              // src={avatar}
              width={78}
              height={78}
              alt="user_profile"
